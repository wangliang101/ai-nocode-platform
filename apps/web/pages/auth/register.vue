  ...
  <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
    <div class="w-full max-w-6xl animate-in fade-in duration-500">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="hidden lg:block animate-in slide-in-from-left duration-700">
          <div class="space-y-6">
            ...
            <div>
              ...
              <p class="text-xl text-gray-600 dark:text-gray-400 mb-8">Create your account to start building amazing applications</p>
            </div>
            <div class="space-y-4 text-gray-600 dark:text-gray-400">
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h3 class="font-semibold text-gray-900 dark:text-white mb-1">Free to Start</h3>
                  <p class="text-sm">Begin building immediately with our generous free tier</p>
                </div>
              </div>
              <div class="flex items-start gap-3">
                <svg class="w-6 h-6 text-indigo-500 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <h3 class="font-semibold text-gray-900 dark:text-white mb-1">No Credit Card</h3>
                  <p class="text-sm">Start building without any payment information required</p>
                </div>
              </div>
              <div class="flex items-start gap-3">
                <svg class="w-6 h-6 text-indigo-500 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  <h3 class="font-semibold text-gray-900 dark:text-white mb-1">Join Thousands</h3>
                  <p class="text-sm">Be part of a growing community of no-code builders</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="w-full">
          ...
          <div class="lg:hidden text-center mb-8 animate-in slide-in-from-top duration-700">
            ...
            <p class="text-base text-gray-600 dark:text-gray-400">Create your account to start building</p>
          </div>
      ...
      <Card class="backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 shadow-2xl border border-gray-200/50 dark:border-gray-700/50 animate-in slide-in-from-bottom duration-700">
        <form @submit.prevent="handleRegister" class="space-y-6 px-2">
          <!-- Email Input -->
          ...
          <!-- Terms Notice -->
          <Alert class="border-indigo-200 dark:border-indigo-800 bg-indigo-50/50 dark:bg-indigo-900/20">
            <svg class="h-5 w-5 text-indigo-600 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <AlertDescription class="text-indigo-700 dark:text-indigo-300">
        ...
        <div class="relative my-8">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-white/90 dark:bg-gray-800/90 text-gray-500 dark:text-gray-400 font-medium">Already registered?</span>
          </div>
        </div>
