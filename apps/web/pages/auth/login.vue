  ...
  <div class="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    <div class="w-full max-w-md px-6">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 dark:text-gray-400">Sign in to continue to AI No-Code Platform</p>
      </div>
      ...
      <Card class="backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 shadow-xl border-0 p-8">
        <form @submit.prevent="handleLogin" class="space-y-5">
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between">
              ...
              <a href="#" class="text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 font-medium">
                Forgot password?
              </a>
            </div>
            <div class="relative">
        ...
        <div class="relative my-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-4 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400">New to platform?</span>
          </div>
        </div>
